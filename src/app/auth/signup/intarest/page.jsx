...
const Page = () => {
  ...
  const interests = [
    { id: 1, label: "Programming", image: image1 },
    { id: 2, label: "Design", image: image2 },
    { id: 3, label: "Marketing", image: image3 },
    { id: 4, label: "Photography", image: image4 },
    { id: 5, label: "Design", image: image2 },
    { id: 6, label: "Marketing", image: image3 },
    { id: 7, label: "Design", image: image2 },
    { id: 8, label: "Marketing", image: image3 },
  ];
