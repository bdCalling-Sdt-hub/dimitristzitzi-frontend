...
const page = () => {
  ...
  return (
    <div className="container mx-auto px-6">
      <h1 className="text-[#000000] text-2xl font-bold lg:py-12 py-4">Shoppingcart</h1>
       <div className="pt-6 border-b-2 border-[#F2F4F7] pb-4 flex items-center justify-between">
       <h3 className=" font-semibold text-[#475467]  text-[16px]">3 courses added in your cart</h3>
       <Link href="/checkout">
            <Button
      ...
      <div>
        {
            carditems.map(item=> <div key={item.id} className=" w-full xl:flex lg:flex md:flex flex-row pb-8 my-4 bg-white border-b-2 border-dashed border-gray-200 overflow-hidden">
                ...
                <div className="p-5 w-full ">
                  ...
                  <div className="flex items-center justify-center xl:gap-12 lg:gap-12 md:gap-12 gap-4">
                    <button className="text-[16px] text-[#B42318] border-b-2 border-[#B42318] font-normal">Remove</button>
                  <Link
                      href={`/checkout`}
